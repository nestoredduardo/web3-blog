...
const WriterItem: React.FC<WriterItemProps> = ({ writer }) => {
  return (
    <Link href={`/${writer.id}`}>
      <li className="bounce my-2 mx-6 flex w-80 cursor-pointer items-center rounded-xl border-2 border-gray-light py-4 px-6 hover:bg-gray-light md:mx-12 md:w-96 lg:w-[450px]">
